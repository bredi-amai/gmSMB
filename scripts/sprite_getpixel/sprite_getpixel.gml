/// @description  sprite_getpixel(sprite, subimg, x, y, returnfloat);
...
/// @param  y
/// @param  returnfloat
function sprite_getpixel(argument0, argument1, argument2, argument3, returnfloat) {
	...
	if (exists == 2){
		...
		{
		    var clr;
		    clr[0] = buffer_read(buff, buffer_u8)/255 + 0.0;
		    clr[1] = buffer_read(buff, buffer_u8)/255 + 0.0;
		    clr[2] = buffer_read(buff, buffer_u8)/255 + 0.0;
		    clr[3] = buffer_read(buff, buffer_u8)/255 + 0.0;
